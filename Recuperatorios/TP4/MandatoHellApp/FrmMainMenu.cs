...
namespace PaisesG20
{
    ...
    {
        private event Notificador notificarCambioEnListaPaises; //AQUI SE DECLARO UN EVENTO
        private event Notificador notificarCargaDeListaPaises; //AQUI SE DECLARO OTRO EVENTO
        ...
        public FrmMainMenu()
        {
            //this.DataGridViewLoad += notificarDbCargada;
            InitializeComponent();
            notificarCargaDeListaPaises = DataGridViewLoad;
            notificarCambioEnListaPaises = DataGridRefresh;
        }
        ...
        private void LoadFromJson()
        {
            ...
            notificarCargaDeListaPaises.Invoke();
        }
        /// <summary>
        ...
        private void AgregarPaisesInvitados()
        {
            if (flagPaisesInvitados == false)
            {
                ...
                notificarCambioEnListaPaises.Invoke();
        ...
        {
            FrmAltaPais menuEmpleado = new FrmAltaPais(notificarCambioEnListaPaises);
