...
namespace PaisesG20
{
    public partial class FrmAltaPais : Form
    {
        ...
        private event Notificador avisarPaisNuevo;
        public FrmAltaPais()
        {
            InitializeComponent();
        }
        public FrmAltaPais(Notificador notificarCambioEnListaPaises):this()
        {
            avisarPaisNuevo = notificarCambioEnListaPaises;
        }
        #region botones
        ...
        /// </summary>
        /// <param name="limpiarYGuardar">Delegado que contiene el metodo para limpiar y guardar la DB</param>
